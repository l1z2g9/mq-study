...
DEFINE QLOCAL('DEV.BACKOUT.Q') DEFPSIST(YES) REPLACE
DEFINE QLOCAL('DEV.QUEUE.1') BOTHRESH(3) BOQNAME('DEV.BACKOUT.Q') DEFPSIST(YES) REPLACE
DEFINE QLOCAL('DEV.QUEUE.2') BOTHRESH(3) BOQNAME('DEV.BACKOUT.Q') DEFPSIST(YES) REPLACE
DEFINE QLOCAL('DEV.QUEUE.3') BOTHRESH(3) BOQNAME('DEV.BACKOUT.Q') DEFPSIST(YES) REPLACE


DEFINE QLOCAL('DEV.DEAD.LETTER.QUEUE') DEFPSIST(YES) REPLACE
ALTER QMGR DEADQ('DEV.DEAD.LETTER.QUEUE')

DEFINE AUTHINFO('DEV.AUTHINFO') AUTHTYPE(IDPWOS) CHCKCLNT(REQDADM) AUTHENMD(OS) CHCKLOCL(OPTIONAL) ADOPTCTX(YES) REPLACE
