...
DEFINE QLOCAL('DEV.QUEUE.1') BOTHRESH(3) BOQNAME('DEV.DEAD.LETTER.QUEUE') DEFPSIST(YES) REPLACE
DEFINE QLOCAL('DEV.QUEUE.2') BOTHRESH(3) BOQNAME('DEV.DEAD.LETTER.QUEUE') DEFPSIST(YES) REPLACE
DEFINE QLOCAL('DEV.QUEUE.3') BOTHRESH(3) BOQNAME('DEV.DEAD.LETTER.QUEUE') DEFPSIST(YES) REPLACE
